...
public class familyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listView = findViewById(R.id.familyTaskListView);
        List<Task> familyTasks = dbHelper.getTasksByCategory("Family");
        taskAdapter = new TaskAdapter(this, new ArrayList<>(familyTasks), dbHelper);
        ...
        navaddtask.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(familyActivity.this, AddtaskActivity.class));
            }
        });
        ...
        navprofile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(familyActivity.this, MyprofileActivity.class));
            }
        });
        ...
        navsettings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(familyActivity.this, settingsActivity.class));
            }
        });
    }
}
